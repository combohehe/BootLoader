...
void aes(void)
{
   ...
   lcdUpdate((char*)"Plain text:", plainText);
...
void dmaAes(void)
{
   ...
   strcpy(plainText, (char*)"The world is going wireless and Chipcon drives this development.");
   ...
   lcdUpdate((char*)"DMA cipher text:", cipherText);
   ...
   lcdUpdate((char*)"DMA plain text:", plainText);
   scrollText(plainText, STRING_LENGTH_DMA);
}
